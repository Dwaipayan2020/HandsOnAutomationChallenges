...
ind = 4
print('Before performing any operation: ', llist.to_list())
print(f'\nupdating val at index {ind}: ')
llist.update_node(ind, 10)
print('updated : ', llist.to_list())
print(f'get val at index {ind}: ', llist.getnode(ind))
print(f'\ndeleting val at index {ind}: ')
llist.delete_node(ind)
print('\nAfter : ', llist.to_list())
print(f'\nget val at index {ind}: ', llist.getnode(ind))
